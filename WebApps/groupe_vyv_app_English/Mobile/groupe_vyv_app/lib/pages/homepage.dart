        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              itemCard('Health Insurance', 'assets/hi.jpg'),
              itemCard('Car Insurance', 'assets/car.jpg')
            ],
          )
        ],
      ),
            ...
            Column(
              children: <Widget>[
                ...
                Container(
                  width: 250.0,
                  child: Text(
                    'In few easy steps just secure your entire family health needs, take a online policy today.Get our full support to resolve your queries and doubts related to Online Policies',
